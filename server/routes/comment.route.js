...
import { deleteComment, getComment, likeComment, unlikeComment, updateComment, uploadComment, uploadCommentAudio } from '../controller/comment.controller.js'
import verifyAccessToken from '../middleware/auth.middleware.js'

const router = express.Router()

router.post('/:id/upload', verifyAccessToken, uploadComment)
router.post('/:id/upload-audio-comment', verifyAccessToken, uploadCommentAudio)
